                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
								<?php
								$query = mysql_query("select * from property where agent_id = '$session_id'")or die(mysql_error());
                            ...
                            <div class="block-content collapse in">
								...
								?>
									<div id="del<?php echo $row['property_id'];?>" class="alert"><i class="icon-list"></i> <?php echo strtoupper(substr($row['property_title'], 0, 20-2) . '&#133'); ?> 
									<i class="alert alert-info">
										<span class="icon-edit icon-small" > <a id="edit_event" href="edit-event.php?id=<?php echo $session_id;?>&event=<?php echo $row['property_id'];?>">EDIT</a></span> | 
										<span class="icon-remove icon-small"> <a class="delete_event" id="<?php echo $row['property_id'];?>" href="<?php echo $row['property_id'];?>">DELETE</a></span> | 
										<span> <a onClick="return false;"id="cancel_event" href="<?php echo $row['property_id'];?>">CANCEL</a></span>
									</i></div>
								<?php } ?>
									</div>
                                </div>
