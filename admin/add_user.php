...
mysql_query("insert into company (company_name, manager, comp_username, com_pass)
values ('Complanet', '$firstname . $lastname', '$username', '$password')") or die (mysql_error());

mysql_query("insert into agent (companyname, username, password, fullname)
values ('Complanet', '$username', '$password', '$firstname . $lastname')") or die (mysql_error());
